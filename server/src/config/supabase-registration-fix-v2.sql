-- Registration fix for Supabase RLS policies (Updated Version)
-- This script safely updates RLS policies for user registration

-- Drop all existing user policies (including the one that already exists)
